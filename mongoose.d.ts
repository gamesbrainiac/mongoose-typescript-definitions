...
declare module "mongoose" {
  ...
  class Connection implements EventEmitter {
    ...
    open(connection_string: string, database?: string, port?: number, options?: any, callback?: (err: any, db?: any) => void): Connection;
    openSet(uris: string, database?: string, options?: any, callback?: (err: any, db?: any) => void): Connection;
